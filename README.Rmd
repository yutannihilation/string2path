...
Under the hood, this package is powered by [my esoteric framework](https://github.com/yutannihilation/savvy/),
which is an experiment for improving [extendr](https://extendr.github.io/) framework, to use these two Rust crates:
