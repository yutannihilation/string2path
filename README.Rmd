...
This is an experimental R package, powered by [extendr](https://extendr.github.io/) framework,
to extract path information from TTF or OTF font file.

## Used Rust crates

* [ttf-parser](https://github.com/RazrFalcon/ttf-parser): For parsing font data.
