...
#'     please refer to [lyon's doc](https://docs.rs/lyon/0.16.2/lyon/index.html#what-is-the-tolerance-variable-in-these-examples).
#' @export
string2vertex <- function(str, ttf_file, tolerance =  0.001, line_width = 1.0, result_type = c("fill", "stroke", "path")) {
  ...
  out <- .Call(string2vertex_impl, str, ttf_file, tolerance, line_width, as.integer(result_type) - 1L)
